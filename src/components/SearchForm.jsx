...
const SearchForm = () => {
  ...
  const getValueObj = (options, val) => options.find(opt => opt.value === val);
  ...
  const customStyles = {
    ...
    option: (provided, state) => ({
      ...provided,
      backgroundColor: state.isSelected ? '#22c55e' : state.isFocused ? '#bbf7d0' : null,
    ...
    <div className="search-form-container">
      ...
      <form onSubmit={handleSubmit} className="form-group-spacing">
        ...
        <div className="search-form-grid search-form-grid-3-cols">
          <div>
            <label htmlFor="postcodeArea" className="search-form-label">Search area</label>
            <input
              type="text"
              id="postcodeArea"
              name="postcodeArea"
          ...
          <div>
            <label htmlFor="type" className="search-form-label">Property type</label>
            <Select 
                isDisabled={false}
                isLoading={false}
                isClearable={false}
        ...
        <div className="search-form-grid search-form-grid-4-cols">
          <div>
            <label htmlFor="minPrice" className="search-form-label">Min Price (£)</label>
            <Select
                name="minPrice"
          ...
          <div>
            <label htmlFor="maxPrice" className="search-form-label">Max Price (£)</label>
             <Select
                name="maxPrice"
          ...
          <div>
            <label htmlFor="minBedrooms" className="search-form-label">Min Beds</label>
             <Select
                name="minBedrooms"
